...
setwd('/home/gehau/git/bodemenondergrond-catalog-publiek/src/main/R')
...
write.csv(collapse_df_on_pipe(df),"../resources/be/vlaanderen/bodemenondergrond/data/id/catalog/bodemenondergrond-catalog-publiek/catalog.csv", row.names = FALSE)
...
system(paste("riot --formatted=TURTLE ", tmp_file, "  > ../resources/be/vlaanderen/bodemenondergrond/data/id/catalog/bodemenondergrond-catalog-publiek/catalog.ttl"))
system("riot --formatted=JSONLD ../resources/be/vlaanderen/bodemenondergrond/data/id/catalog/bodemenondergrond-catalog-publiek/catalog.ttl > ../resources/be/vlaanderen/bodemenondergrond/data/id/catalog/bodemenondergrond-catalog-publiek/catalog.jsonld")
