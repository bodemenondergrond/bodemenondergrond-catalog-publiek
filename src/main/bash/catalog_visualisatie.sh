...
sparql --data=../resources/be/vlaanderen/bodemenondergrond/data/id/catalog/bodemenondergrond-catalog-publiek/catalog.ttl --query ../sparql/catalog_visualisatie.sparql --results=TURTLE | rdf2dot  | dot -Tpng > ../sparql/catalog_visualisatie.png
pushd  ../../..
git pull
mvn clean install
